...
from BootApp import views as v
...
urlpatterns = [
    ...
    path('st/',v.std,name="sty"),
    path('stp/<int:g>/',v.stpd,name="stpud"),
    path('std/<int:a>/',v.stdd,name="stdlt"),
    path('',v.emp,name="em"),
    path('empp/<int:n>/',v.empup,name="emupd"),
    path('empd/<int:q>/',v.empdd,name="empdt"),
]
